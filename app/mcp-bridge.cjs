...
const ASSET_GUIDES = {
  module: [
    ...
    '    · TTS: window.mdpTts.speak(text, {lang, voice, speaker, rate, onProgress}) speaks with the user-configured narrator (Web Speech / VOICEVOX with automatic fallback); mdpTts.stop() stops. See @speakcard / @speak for the reference implementation of cross-surface audio.',
